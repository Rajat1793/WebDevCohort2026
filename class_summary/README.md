...
📚 [Browse all articles](../articles/README.md)

---

### Day 0:
**Topic:** Course Overview and Introduction to Git
**Date:** 27th December 2026
**Summary**
    In this introductory class, we were given an overview of the Web Dev Cohort course structure and what to expect in the coming weeks. We also had our first hands-on experience with Git, learning the basics of version control, including how to initialize a repository, make commits, and push changes to a remote repository on GitHub.
...
**Summary**
    In this class, we covered the basics of computer networks, and how they enable communication between devices and how we open a webpage using a browser, who is responsible for opening the webpage, and what are the steps involved in opening a webpage, how the webpage is fetched from the server.
